...
var i_13487 = (0);
while(true){
if((i_13487 < arr.length)){
(arr[i_13487] = null);

var G__13489 = (i_13487 + (1));
i_13487 = G__13489;
continue;
} else {
}
...
var i_13508 = (self__.level + (1));
while(true){
if((i_13508 <= (new_level + (1)))){
(update[i_13508] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13513 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13513[i]));
} else {
x__$2.forward.push((((i < links_13513.length))?(links_13513[i]):null));
}

if((i < links_13513.length)){
(links_13513[i] = x__$2);
} else {
links_13513.push(x__$2);
}
...
var i_13518 = (0);
while(true){
if((i_13518 <= self__.level)){
var links_13522 = (update[i_13518]).forward;
if((x__$1 === (((i_13518 < links_13522.length))?(links_13522[i_13518]):null))){
(links_13522[i_13518] = (x__$1.forward[i_13518]));

var G__13523 = (i_13518 + (1));
i_13518 = G__13523;
continue;
} else {
var G__13524 = (i_13518 + (1));
i_13518 = G__13524;
continue;
}
} else {
