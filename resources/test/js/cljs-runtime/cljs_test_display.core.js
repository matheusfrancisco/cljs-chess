...
var node = (function (){var G__20835 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__20836 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__20837 = style_string_21083;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__20835,G__20836,G__20837) : cljs_test_display.core.n.call(null,G__20835,G__20836,G__20837));
})();
...
var len__5769__auto___21094 = arguments.length;
var i__5770__auto___21095 = (0);
while(true){
if((i__5770__auto___21095 < len__5769__auto___21094)){
args__5775__auto__.push((arguments[i__5770__auto___21095]));

var G__21096 = (i__5770__auto___21095 + (1));
i__5770__auto___21095 = G__21096;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq20853){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20854,G__20855,seq20853__$2);
}));
...
var vec__20901 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20901,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20901,(1),null);
var G__20911 = cljs.core.PersistentArrayMap.EMPTY;
var G__20911__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20911,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20911);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20911__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__20911__$1;
}
} else {
...
return (function() { 
var G__21105__delegate = function (klass,contents){
var vec__20919 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20919,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20919,(1),null);
...
var G__21105 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21106__i = 0, G__21106__a = new Array(arguments.length -  1);
while (G__21106__i < G__21106__a.length) {G__21106__a[G__21106__i] = arguments[G__21106__i + 1]; ++G__21106__i;}
  contents = new cljs.core.IndexedSeq(G__21106__a,0,null);
} 
return G__21105__delegate.call(this,klass,contents);};
G__21105.cljs$lang$maxFixedArity = 1;
G__21105.cljs$lang$applyTo = (function (arglist__21107){
var klass = cljs.core.first(arglist__21107);
var contents = cljs.core.rest(arglist__21107);
return G__21105__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__20956){
var map__20958 = p__20956;
var map__20958__$1 = cljs.core.__destructure_map(map__20958);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20958__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20958__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__20983){
var map__20984 = p__20983;
var map__20984__$1 = cljs.core.__destructure_map(map__20984);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20984__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20984__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21002){
var map__21004 = p__21002;
var map__21004__$1 = cljs.core.__destructure_map(map__21004);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21004__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21004__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__21016_SHARP_){
return cljs.core.cons(new_current_node,p1__21016_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__21027 = cljs_test_display.core.current_var_info();
var map__21027__$1 = cljs.core.__destructure_map(map__21027);
var info = map__21027__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21027__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21027__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21027__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__21026_SHARP_){
return cljs.core.cons(node,p1__21026_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21035){
var map__21036 = p__21035;
var map__21036__$1 = cljs.core.__destructure_map(map__21036);
var m = map__21036__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21036__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21036__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21036__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21036__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__21053 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__21053) : formatter_fn.call(null,G__21053));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__21055 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__21055) : formatter_fn.call(null,G__21055));
})()], 0));
});
...
var temp__5804__auto___21130 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___21130)){
var message_21132 = temp__5804__auto___21130;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_21132], 0));
} else {
}
...
var temp__5804__auto___21133 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5804__auto___21133)){
var message_21134 = temp__5804__auto___21133;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_21134], 0));
} else {
}
