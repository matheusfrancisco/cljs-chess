...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20419_SHARP_){
return html_coll.item(p1__20419_SHARP_);
...
return cljs.core.some((function (p1__20421_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__20421_SHARP_);
...
var ctx_20461 = cvs.getContext("2d");
(ctx_20461.fillStyle = color);

ctx_20461.fillRect((0),(0),size,size);
